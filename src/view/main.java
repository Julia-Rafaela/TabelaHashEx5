...
public class main {
	  public static void main(String[] args) {
	        tabela tabela = new tabela(100); // Tamanho da tabela de espalhamento
	        ...
	        do {
	            ...
	            switch (opcao) {
	                case 1:
	                    ...
	                    contabanco conta = new contabanco(numeroConta, nomeCliente, saldo);
	                ...
	                case 2:
	                    ...
	                    contabanco contaConsulta = tabela.consultar(numeroConsulta);
